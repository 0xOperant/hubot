...
franchiseServices = {
  ...
  "multiverse" : "masterofallscience.com",
}
...
getFranchiseServiceUrl = (franchise) ->
  if !franchise of franchiseServices then franchise = "multiverse"
...
module.exports = (robot) ->
  robot.respond /((simpsons|futurama|multiverse) (search|me)) (.*)/i, (msg) ->
    franchise = msg.match[2] || "multiverse"
